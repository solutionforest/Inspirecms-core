...
title: Templates
slug: templates
path: docs/v1/templates
uri: /docs/1.x/templates
---
# Templates
...
2. Select your target [document type](./document-type){.doc-link}
...
For detailed information about available field types and their configuration options, please see the [Custom Fields documentation](./custom-fields){.doc-link}.

### Using Fields in Templates

> [!Note] 
> For comprehensive documentation on property directives, see the [Content](./fe-content){.doc-link} documentation and [Blade](./blade){.doc-link} documentation.
...
> [!Note] 
> For more detailed examples of layout components, see the [Layouts](./layouts){.doc-link} documentation.
...
> [!NOTE]
> For detailed information about template inheritance patterns, see the [Layouts](./layouts){.doc-link} documentation.
