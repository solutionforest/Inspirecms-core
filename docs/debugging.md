...
title: Debugging
slug: debugging
path: docs/v1/debugging
uri: /docs/1.x/debugging
---
# Debugging
...
> [!warning] 
> Never enable debug mode in production environments as it exposes sensitive information.
...
Create a temporary debug route in `routes/web.php` to check your environment:
