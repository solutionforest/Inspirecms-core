...
path: docs/v1/security-best-practices
uri: /docs/1.x/security-best-practices
---
...
2. Use proper production values
...
```php {title="app/Http/Middleware/ContentSecurityPolicy.php"}
...
```php {title="app/Http/Middleware/SecurityHeaders.php"}
namespace App\Http\Middleware;
