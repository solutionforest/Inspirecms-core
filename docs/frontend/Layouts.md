...
> **Note:** For additional component examples and best practices, see the [Components](./Components.md) documentation.
...
> **Note:** For more detailed examples of using templates, see the [Templates](./Templates.md) documentation.
...
See the common troubleshooting tips in the [Templates](./Templates.md#troubleshooting-common-issues) documentation.