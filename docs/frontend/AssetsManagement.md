...
For detailed media configuration options, please refer to the [Media Management](../getting-started/Configuration.md#media-management) section in the configuration documentation.
