...
namespace SolutionForest\InspireCmsVisualEditor\AI\Services;

use SolutionForest\InspireCmsVisualEditor\AI\Contracts\AIProviderInterface;
use SolutionForest\InspireCmsVisualEditor\AI\Prompts\LayoutPromptBuilder;
...
class LayoutGeneratorService
{
    ...
    {
        $preferred = config('visual-editor.ai.provider', 'anthropic');
