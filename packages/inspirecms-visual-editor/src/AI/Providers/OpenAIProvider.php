...
class OpenAIProvider implements AIProviderInterface
{
    ...
    {
        $this->apiKey = config('visual-editor.ai.openai.api_key', '');
        $this->baseUrl = config('visual-editor.ai.openai.base_url', $this->baseUrl);
        $this->defaultModel = config('visual-editor.ai.openai.model', $this->defaultModel);
    }
