...
@php
    ...
    $extraSubNavigation = $this->getCachedExtraSubNavigation();
    $extraSubNavigationPosition = $this->getExtraSubNavigationPosition();
@endphp
...
>
    ...
    >
        ...
        >
            ...
            @if ($extraSubNavigation)

                <x-filament-panels::page.sub-navigation.select
                    :navigation="$extraSubNavigation"
                />

                @if ($extraSubNavigationPosition === SubNavigationPosition::Start)
                    <x-filament-panels::page.sub-navigation.sidebar
                        :navigation="$extraSubNavigation"
                    />
                @endif
            ...
            >
                ...
                @if ($extraSubNavigation && $extraSubNavigationPosition === SubNavigationPosition::Top)
                    <x-filament-panels::page.sub-navigation.tabs
                        :navigation="$extraSubNavigation"
                    />
                @endif
            ...
            @if ($extraSubNavigation && $extraSubNavigationPosition === SubNavigationPosition::End)
                <x-filament-panels::page.sub-navigation.sidebar
                    :navigation="$extraSubNavigation"
                />
            @endif
