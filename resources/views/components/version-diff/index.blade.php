...
<div {{ $attributes->class(['version-diff bg-white dark:bg-gray-900 dark:divide-white/10 divide-y overflow-hidden ring-1 ring-gray-950/5 dark:ring-white/10 rounded-xl shadow-sm']) }}>
    @if (isset($heading))
