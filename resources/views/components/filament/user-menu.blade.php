@php
    ...
    $ensureExtraAttributeForMenuIten = function ($item) {
    ...
    $ensureTagForMenuItem = function ($item, $itemPostAction) {
    ...
    <x-filament::dropdown.list>
        @foreach ($items as $key => $item)
            @php
                ...
                $extraAttributes = $ensureExtraAttributeForMenuIten($item);
            @endphp
            ...
            <x-filament::dropdown.list.item
                ...
                :tag="$ensureTagForMenuItem($item, $itemPostAction)"
                :target="$item->shouldOpenUrlInNewTab() ? '_blank' : null"
                :attributes="new Illuminate\View\ComponentAttributeBag($extraAttributes)"
            >
                {{ $item->getLabel() }}
            </x-filament::dropdown.list.item>
        @endforeach
