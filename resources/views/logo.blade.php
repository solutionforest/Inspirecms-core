...
<svg
    ...
    @class([
        'inspirecms-logo',
        'h-full w-auto text-custom-500 dark:text-custom-400 font-sans font-bold tracking-wide',
    ])
    @style([
...
>
    <defs>
        <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" style="stop-color: var(--color-700); stop-opacity:1" />
            <stop offset="100%" style="stop-color: var(--color-300); stop-opacity:1" />
        </linearGradient>
    </defs>
    @if ($hasTitle)
