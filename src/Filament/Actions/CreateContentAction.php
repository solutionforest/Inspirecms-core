...
use SolutionForest\InspireCms\Filament\Resources\Contents\Actions\CreateContentAction as CreateContentActionConfig;
    ...
    protected function setUp(): void
    {
        ...
        $this
            ...
            ->action(function (array $data, $livewire) {
                $url = CreateContentActionConfig::generateCreateContentUrl(
