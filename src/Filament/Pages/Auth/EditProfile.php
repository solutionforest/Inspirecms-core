...
class EditProfile extends BasePage
{
    ...
    {
        return __('inspirecms::pages/auth/edit-profile.label');
    }

    protected function getSavedNotificationTitle(): ?string
    {
        return __('inspirecms::pages/auth/edit-profile.notifications.saved.title');
    }

    protected function getSaveFormAction(): Action
    {
        return Action::make('save')
            ->label(__('inspirecms::pages/auth/edit-profile.form.actions.save.label'))
            ->submit('save')
            ->keyBindings(['mod+s']);
    }
    ...
    public function getCancelFormAction(): Action
    {
        return Action::make('back')
            ->label(__('inspirecms::pages/auth/edit-profile.actions.cancel.label'))
