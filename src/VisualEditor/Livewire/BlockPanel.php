...
use SolutionForest\InspireCms\VisualEditor\Models\BlockTemplate;
...
class BlockPanel extends Component
{
    ...
    {
        $this->dispatch('add-block', type: $type)->to(VisualEditor::class);
    }
    ...
    public function addTemplate(string $templateId): void
    {
        ...
        if ($template) {
            ...
            $this->dispatch('add-block-data', blockData: $blockData)->to(VisualEditor::class);
        }
    }
    ...
    {
        return view('inspirecms::visual-editor.livewire.block-panel');
    }
}
