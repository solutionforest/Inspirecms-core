...
class AIAssistant extends Component
{
    ...
    public function generateLayout(): void
    {
        ...
        try {
            ...
            if ($result['success']) {
                $this->dispatch('apply-ai-layout', layoutData: $result['layout'])->to(VisualEditor::class);
    ...
    {
        $this->dispatch('add-block-data', blockData: $suggestion['blockData'])->to(VisualEditor::class);
    ...
    public function useHistoryItem(string $historyId): void
    {
        ...
        if ($item && isset($item->result['layout'])) {
            $this->dispatch('apply-ai-layout', layoutData: $item->result['layout'])->to(VisualEditor::class);
    ...
    {
        return view('inspirecms::visual-editor.livewire.ai-assistant');
    }
}
