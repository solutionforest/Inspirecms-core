 ...
 * @property Form $form
 */
class BaseCreateChildrentPage extends Page
{
    ...
    #[Locked]
    public null | Model | string | int $parent = null;
    ...
    {
        return static::$breadcrumb ?? __('inspirecms::resources/pages/create-children.breadcrumb');
    }
    ...
    public function getBreadcrumbs(): array
    {
        ...
        try {
            ...
            foreach (['view', 'edit'] as $action) {
                ...
                if ($resource::hasPage($action) && $resource::can($action, $this->getParentRecord())) {
                    $parentUrl = $resource::getUrl($action, ['record' => $this->getParentRecord()]);
                }
            }
            ...
            if (filled($parentUrl)) {
                ...
                $parentTitle = ! $resource::hasRecordTitle()
                    ? $resource::getTitleCaseModelLabel()
                    : $resource::getRecordTitle($this->getParentRecord());

                $breadcrumbs[$parentUrl] = $parentTitle;
            }
        }

        if (filled($breadcrumb = $this->getBreadcrumb())) {
    ...
    public function mount(int | string $parent): void
    {
        $this->parent = $this->resolveParentRecord($parent);
    ...
    public function getTitle(): string | Htmlable
    {
        ...
        return __('inspirecms::resources/pages/create-children.title', [
